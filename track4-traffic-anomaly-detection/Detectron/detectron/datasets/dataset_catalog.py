...
# Available datasets
_DATASETS = {
    'car_detection_dark_train': {
        _IM_DIR:
            _DATA_DIR + '/car-detection-dark/train/images',
        _ANN_FN:
            _DATA_DIR + '/car-detection-dark/train/annotations/car_detection_dark.json'
    },
    'car_detection_dark_val': {
        _IM_DIR:
            _DATA_DIR + '/car-detection-dark/val/images',
        _ANN_FN:
            _DATA_DIR + '/car-detection-dark/val/annotations/car_detection_dark.json'
    },
    'car_detection_train': {
        _IM_DIR:
            _DATA_DIR + '/car-detection/images',
        _ANN_FN:
            _DATA_DIR + '/car-detection/annotations/train_cars.json'
    },
    'car_detection_val': {
        _IM_DIR:
            _DATA_DIR + '/car-detection/images',
        _ANN_FN:
            _DATA_DIR + '/car-detection/annotations/val_cars.json'
    },
    'coco_2017_train': {
        _IM_DIR:
